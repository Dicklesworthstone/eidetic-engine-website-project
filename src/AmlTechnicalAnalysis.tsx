...
// Create a pulsing node for diagram
const PulsingNode = ({ icon, text, position, color }) => (
    <div className={`absolute ${position}`}>
        <div className={`relative group`}>
            <div className={`absolute inset-0 ${color} rounded-full opacity-30 animate-ping`}></div>
            <div className={`relative ${color} p-3 rounded-full`}>
                {icon}
            </div>
            <div className="invisible group-hover:visible absolute mt-2 bg-gray-900 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
                {text}
            </div>
        </div>
    </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg prose-invert max-w-none space-y-6 text-gray-300">
                <div className="bg-gradient-to-br from-gray-800/60 to-gray-800/40 p-6 rounded-xl border border-purple-700/30 shadow-lg">
                    ...
                    <div className="relative w-full h-96 mb-8 bg-gray-900/70 rounded-xl overflow-hidden border border-purple-700/20">
                        {/* Central "Engine Core" */}
...
const AmlTechnicalAnalysis = () => {
                ...
                <main className={`flex-1 transition-margin duration-300 ease-in-out ${showNavigation ? 'md:ml-64' : 'ml-0'} overflow-x-hidden`}>
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="prose prose-lg prose-invert max-w-none space-y-6 text-gray-300">
                                    ...
                                    <div className="relative w-full h-64 mt-12 mb-8 bg-gray-900/60 rounded-xl overflow-hidden border border-gray-700/30">
                                        ...
                                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                            <div className="relative">
                                                ...
                                                <div className="relative w-16 h-16 bg-purple-900/80 rounded-full border-2 border-purple-500/70 flex items-center justify-center shadow-lg shadow-purple-500/30">
                                        ...
                                        <PulsingNode
                                            icon={<GitBranch className="w-5 h-5 text-green-300" />}
                                        ...
                                        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                                            {/* Database to AML */}
                                            <line x1="25%" y1="25%" x2="50%" y2="50%" stroke="url(#blue-gradient)" strokeWidth="2" strokeDasharray="5,5" />

                                            {/* LLM to AML */}
                                            <line x1="75%" y1="25%" x2="50%" y2="50%" stroke="url(#indigo-gradient)" strokeWidth="2" strokeDasharray="5,5" />

                                            {/* Planning to AML */}
                                            <line x1="25%" y1="75%" x2="50%" y2="50%" stroke="url(#green-gradient)" strokeWidth="2" strokeDasharray="5,5" />

                                            {/* Goals to AML */}
                                            <line x1="75%" y1="75%" x2="50%" y2="50%" stroke="url(#amber-gradient)" strokeWidth="2" strokeDasharray="5,5" />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div className="bg-gray-800/70 p-5 rounded-lg border border-purple-800/30">
                                            <h4 className="font-bold text-purple-300 mb-2 flex items-center">
                                                <Layers className="w-4 h-4 mr-2 text-purple-400" /> Background Task Management
                                            </h4>
                                            <p className="text-sm text-gray-300">Robust concurrent processing with resource protection.</p>
                                        </div>

                                        <div className="bg-gray-800/70 p-5 rounded-lg border border-purple-800/30">
                                            <h4 className="font-bold text-purple-300 mb-2 flex items-center">
                                                <Telescope className="w-4 h-4 mr-2 text-purple-400" /> Structure-Aware Context
                                            </h4>
                                            <p className="text-sm text-gray-300">Multi-faceted context with freshness indicators and prioritization.</p>
                                        </div>

                                        <div className="bg-gray-800/70 p-5 rounded-lg border border-purple-800/30">
                                            <h4 className="font-bold text-purple-300 mb-2 flex items-center">
                                                <CheckCircle className="w-4 h-4 mr-2 text-purple-400" /> Plan Validation
                                            </h4>
                                            <p className="text-sm text-gray-300">Cycle detection and structure checks for robust planning.</p>
                                        </div>

                                        <div className="bg-gray-800/70 p-5 rounded-lg border border-purple-800/30 md:col-span-2">
                                            <h4 className="font-bold text-purple-300 mb-2 flex items-center">
                                                <AlertTriangle className="w-4 h-4 mr-2 text-purple-400" /> Categorized Error Handling
                                            </h4>
                                            <p className="text-sm text-gray-300">Typed errors with specific recovery strategies for robustness.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="data-structures" className="mb-16 scroll-mt-20">
                            <div className="max-w-4xl mx-auto">
                                <h2 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 flex items-center">
                                    <List className="w-8 h-8 mr-3 text-purple-400 flex-shrink-0" /> Core Data Structures
                                </h2>
                                <div className="prose prose-lg prose-invert max-w-none space-y-6 text-gray-300">
                                    <div className="bg-gradient-to-br from-gray-800/60 to-gray-800/40 p-6 rounded-xl border border-gray-700/50 shadow-lg">
                                        <h3 className="text-2xl font-bold mb-4 text-purple-300 flex items-center">
                                            ...
                                            <InlineCode>PlanStep</InlineCode> (Pydantic BaseModel)
                                        </h3>
                                        <CodeBlock language="python">{`class PlanStep(BaseModel):
    ...
    is_parallel_group: Optional[str] = None`}</CodeBlock>
                                        <p className="mt-4">
                                            Represents a single plan step, tracking ID, description, status, dependencies, tool info, results, and parallel grouping.
                                        </p>
                                    </div>

                                    <div className="bg-gradient-to-br from-gray-800/60 to-gray-800/40 p-6 rounded-xl border border-gray-700/50 shadow-lg mt-8">
                                        <h3 className="text-2xl font-bold mb-4 text-purple-300 flex items-center">
                                            <List className="w-5 h-5 mr-2 text-purple-400" />
                                            <InlineCode>AgentState</InlineCode> (Dataclass)
                                        </h3>
...
class AgentState:
    ...
    # Meta-cognition metrics & thresholds
    ...
    background_tasks: Set[asyncio.Task] = field(...)`}</CodeBlock>
                                        <p className="mt-4">
                                            Maintains comprehensive state including workflow/goal context, plan, thought records, errors, meta-cognitive metrics/thresholds, tool stats, and background tasks.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section id="constants" className="mb-16 scroll-mt-20">
                            <div className="max-w-4xl mx-auto">
                                <h2 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 flex items-center">
                                    <Settings className="w-8 h-8 mr-3 text-purple-400 flex-shrink-0" /> Key Constants and Configuration
                                </h2>
                                <div className="prose prose-lg prose-invert max-w-none space-y-6 text-gray-300">
                                    <div className="bg-gradient-to-br from-gray-800/60 to-gray-800/40 p-6 rounded-xl border border-gray-700/50 shadow-lg">
                                        <p>
                                            Numerous constants configure system behavior, often overridable via environment variables:
                                        </p>
                                        <CodeBlock language="python">{`# File and agent identification
...
# Meta-cognition thresholds & Bias
BASE_REFLECTION_THRESHOLD = int(os.environ.get("...", "7"))
BASE_CONSOLIDATION_THRESHOLD = int(os.environ.get("...", "12"))
MIN_REFLECTION_THRESHOLD = 3
MAX_REFLECTION_THRESHOLD = 15
# ... other thresholds ...
THRESHOLD_ADAPTATION_DAMPENING = float(os.environ.get("...", "0.75"))
MOMENTUM_THRESHOLD_BIAS_FACTOR = 1.2 # Key for Mental Momentum

# Interval constants (loops)
OPTIMIZATION_LOOP_INTERVAL = int(os.environ.get("...", "8"))
MEMORY_PROMOTION_LOOP_INTERVAL = int(os.environ.get("...", "15"))
STATS_ADAPTATION_INTERVAL = int(os.environ.get("...", "10"))
MAINTENANCE_INTERVAL = int(os.environ.get("...", "50"))

# Context limits
CONTEXT_RECENT_ACTIONS_FETCH_LIMIT = 10
# ... other context limits ...

# Background task management
BACKGROUND_TASK_TIMEOUT_SECONDS = 60.0
MAX_CONCURRENT_BG_TASKS = 10`}</CodeBlock>

                                        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-purple-700/30">
                                                <h4 className="font-bold text-purple-300 mb-2 flex items-center">
                                                    <Activity className="w-4 h-4 mr-2 text-purple-400" /> Mental Momentum
                                                </h4>
                                                <p className="text-sm text-gray-300">
                                                    The <InlineCode>MOMENTUM_THRESHOLD_BIAS_FACTOR</InlineCode> (1.2) applies additional weight to threshold increases during smooth operation, reducing cognitive overhead.
                                                </p>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-blue-700/30">
                                                <h4 className="font-bold text-blue-300 mb-2 flex items-center">
                                                    <Layers className="w-4 h-4 mr-2 text-blue-400" /> Threshold Adaptation
                                                </h4>
                                                <p className="text-sm text-gray-300">
                                                    <InlineCode>THRESHOLD_ADAPTATION_DAMPENING</InlineCode> (0.75) prevents wild oscillations in meta-cognitive activity by smoothing adjustments.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
def _detect_plan_cycle(self, plan: List[PlanStep]) -> bool: ...`}</CodeBlock>
                                ...
                                <div className="prose prose-lg prose-invert max-w-none space-y-6 text-gray-300">
                                    ...
                                    <div className="bg-gray-800/50 p-6 rounded-xl border border-blue-700/30 shadow-lg mt-8">
                                        ...
                                        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-blue-700/20">
                                                <h4 className="font-bold text-blue-300 mb-2 flex items-center">
                                                    <Telescope className="w-4 h-4 mr-2 text-blue-400" /> Proactive Memories
                                                </h4>
                                                <p className="text-xs text-gray-300">
                                                    Goal-directed hybrid search results (with freshness timestamp)
                                                </p>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-blue-700/20">
                                                <h4 className="font-bold text-blue-300 mb-2 flex items-center">
                                                    <Code className="w-4 h-4 mr-2 text-blue-400" /> Procedural Memories
                                                </h4>
                                                <p className="text-xs text-gray-300">
                                                    Relevant "how-to" knowledge search results (with freshness timestamp)
                                                </p>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-blue-700/20">
                                                <h4 className="font-bold text-blue-300 mb-2 flex items-center">
                                                    <GitMerge className="w-4 h-4 mr-2 text-blue-400" /> Contextual Link Traversal
                                                </h4>
                                                <p className="text-xs text-gray-300">
                                                    Explores links from focal/working/important memory (with freshness timestamp)
                                                </p>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-blue-700/20">
                                                <h4 className="font-bold text-blue-300 mb-2 flex items-center">
                                                    <Package className="w-4 h-4 mr-2 text-blue-400" /> Context Compression
                                                </h4>
                                                <p className="text-xs text-gray-300">
                                                    Checks token limits, compresses verbose parts using UMS summarizer if needed
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    {/* Sub-section: LLM Interaction */}
                                    <div className="bg-gray-800/50 p-6 rounded-xl border border-indigo-700/30 shadow-lg mt-8">
                                        <h3 className="text-2xl font-bold mb-4 text-indigo-300 flex items-center">
                                            <MessageCircle className="w-6 h-6 mr-2 text-indigo-400 flex-shrink-0" /> LLM Interaction (<InlineCode>_call_agent_llm</InlineCode>)
                                        </h3>

                                        <ul className="space-y-2 list-disc pl-5">
                                            <li>Constructs detailed prompt (<InlineCode>_construct_agent_prompt</InlineCode>) including system instructions, tools, goal context, process guidance, error recovery strategies, last error details, meta-feedback, and final instruction.</li>
                                            <li>Defines tools for Anthropic API.</li>
                                            <li>Makes API call with retry logic.</li>
                                            <li>Parses response into structured decisions (tool call, thought, completion, error, plan update).</li>
                                        </ul>

                                        <div className="mt-6 relative p-4 bg-indigo-900/20 rounded-lg border border-indigo-700/30 flex items-center">
                                            <Brain className="w-12 h-12 text-indigo-400 mr-4 flex-shrink-0" />
                                            <div>
                                                <h4 className="font-bold text-indigo-300 mb-1">LLM Core</h4>
                                                <p className="text-sm text-gray-300">
                                                    Using Claude 3.5 Sonnet (model string "claude-3-5-sonnet-20240620") for reasoning, planning, and decision making.
                                                </p>
                                            </div>
                                        </div>
                                    </div>

                                    {/* Sub-section: Tool Execution */}
                                    <div className="bg-gray-800/50 p-6 rounded-xl border border-emerald-700/30 shadow-lg mt-8">
                                        <h3 className="text-2xl font-bold mb-4 text-emerald-300 flex items-center">
                                            <Terminal className="w-6 h-6 mr-2 text-emerald-400 flex-shrink-0" /> Tool Execution System (<InlineCode>_execute_tool_call_internal</InlineCode>)
                                        </h3>

                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-emerald-700/20">
                                                <h4 className="font-bold text-emerald-300 mb-2 flex items-center">
                                                    <Server className="w-4 h-4 mr-2 text-emerald-400" /> Server Interaction
                                                </h4>
                                                <ul className="text-xs text-gray-300 space-y-1 list-disc pl-4">
                                                    <li>Finds server (<InlineCode>_find_tool_server</InlineCode>)</li>
                                                    <li>Injects context IDs</li>
                                                    <li>Executes via MCPClient with retry (<InlineCode>_with_retries</InlineCode>)</li>
                                                </ul>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-emerald-700/20">
                                                <h4 className="font-bold text-emerald-300 mb-2 flex items-center">
                                                    <CheckCircle className="w-4 h-4 mr-2 text-emerald-400" /> Dependency & Validation
                                                </h4>
                                                <ul className="text-xs text-gray-300 space-y-1 list-disc pl-4">
                                                    <li>Checks dependencies (<InlineCode>_check_prerequisites</InlineCode>)</li>
                                                    <li>Handles internal tools (<InlineCode>AGENT_TOOL_UPDATE_PLAN</InlineCode>)</li>
                                                    <li>Validates plan updates (<InlineCode>_detect_plan_cycle</InlineCode>)</li>
                                                </ul>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-emerald-700/20">
                                                <h4 className="font-bold text-emerald-300 mb-2 flex items-center">
                                                    <Database className="w-4 h-4 mr-2 text-emerald-400" /> Recording & Tracking
                                                </h4>
                                                <ul className="text-xs text-gray-300 space-y-1 list-disc pl-4">
                                                    <li>Records action start/dependencies</li>
                                                    <li>Processes result, categorizes errors</li>
                                                    <li>Records action completion</li>
                                                </ul>
                                            </div>

                                            <div className="bg-gray-900/60 p-4 rounded-lg border border-emerald-700/20">
                                                <h4 className="font-bold text-emerald-300 mb-2 flex items-center">
                                                    <Layers className="w-4 h-4 mr-2 text-emerald-400" /> State Management
                                                </h4>
                                                <ul className="text-xs text-gray-300 space-y-1 list-disc pl-4">
                                                    <li>Triggers background tasks (auto-linking, promotion)</li>
                                                    <li>Updates state (stats, errors, summary)</li>
                                                    <li>Handles side effects (<InlineCode>_handle_workflow_and_goal_side_effects</InlineCode>)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-gray-800/50 p-6 rounded-xl border border-amber-700/30 shadow-lg mt-8">
                                        ...
                                        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <div className="bg-blue-900/20 p-4 rounded-lg border border-blue-700/30">
                                                <h4 className="font-bold text-blue-300 mb-2 text-center">Completion</h4>
                                                <p className="text-xs text-gray-300 text-center">
                                                    Marks success, adds finalization step
                                                </p>
                                            </div>

                                            <div className="bg-amber-900/20 p-4 rounded-lg border border-amber-700/30 md:col-span-2">
                                                <h4 className="font-bold text-amber-300 mb-2 text-center">Error/Unknown</h4>
                                                <p className="text-xs text-gray-300 text-center">
                                                    Inserts re-evaluation step, forces replan
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-6 bg-amber-900/20 p-4 rounded-lg border border-amber-700/30">
                                            <p className="text-sm text-gray-300">
                                                Updates meta-cognitive counters based on outcome. Implements nuanced strategies for different decision types.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                        ...
                                        <div className="bg-gray-800/50 p-6 rounded-xl border border-emerald-700/30 shadow-lg">
                                            <h3 className="text-xl font-bold mb-4 text-emerald-300 flex items-center">
                                                <Layers className="w-5 h-5 mr-2 text-emerald-400 flex-shrink-0" /> Background Task Management
                                            </h3>

                                            <p className="text-sm">Handles non-blocking cognitive processes reliably:</p>

                                            <ul className="mt-3 space-y-1 list-disc pl-5 text-sm">
                                                <li>State snapshotting ensures consistent context.</li>
                                                <li>Semaphore-based concurrency limiting.</li>
                                                <li>Timeout handling prevents hanging tasks.</li>
                                                <li>Thread-safe tracking using locks.</li>
                                                <li>Guaranteed resource release via completion callbacks.</li>
                                            </ul>
                                        </div>

                                        <div className="bg-gray-800/50 p-6 rounded-xl border border-purple-700/30 shadow-lg">
                                            <h3 className="text-xl font-bold mb-4 text-purple-300 flex items-center">
                                                <Clock className="w-5 h-5 mr-2 text-purple-400 flex-shrink-0" /> Periodic Meta-Cognitive Tasks
                                            </h3>

                                            <p className="text-sm">Orchestrates scheduled cognitive maintenance:</p>

                                            <ul className="mt-3 space-y-1 list-disc pl-5 text-sm">
                                                <li>Stats Computation & Threshold Adaptation (<InlineCode>STATS_ADAPTATION_INTERVAL</InlineCode>).</li>
                                                <li>Reflection (threshold / replan flag triggered).</li>
                                                <li>Consolidation (threshold triggered).</li>
                                                <li>Working Memory Optimization (<InlineCode>OPTIMIZATION_LOOP_INTERVAL</InlineCode>).</li>
                                                <li>Memory Promotion Check (<InlineCode>MEMORY_PROMOTION_LOOP_INTERVAL</InlineCode>).</li>
                                                <li>Maintenance (e.g., <InlineCode>delete_expired_memories</InlineCode>).</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {/* --- SECTION: Token Estimation and Context Management --- */}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="bg-gradient-to-br from-gray-800/60 to-gray-800/40 p-6 rounded-xl border border-blue-700/30 shadow-lg h-full">
                                            ...
                                            <ul className="space-y-2 list-disc pl-5 text-sm">
                                                ...
                                                <li>Handles errors gracefully, preserves original file on failure</li>
                                            </ul>
                                        </div>
                        ...
                        {/* --- SECTION: Driver and Entry Point --- */}
                        ...
                        <section id="integration" className="mb-16 scroll-mt-20">
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="prose prose-lg prose-invert max-w-none space-y-6 text-gray-300">
                                    <div className="bg-gradient-to-br from-gray-800/60 to-gray-800/40 p-6 rounded-xl border border-indigo-700/30 shadow-lg">
                                        <p className="mb-6">
                                            Describes the complete operational flow:
                                        </p>
